...
def make_recommendations(df_clean, df_cancelled):
    ...
    print(
        f"3. Revenue protection: Clean sales total ${total_revenue:,.2f}. Keep "
        "the positive-quantity and positive-price checks in future reports so "
        "zero-price or negative transactions do not distort revenue."
    )
